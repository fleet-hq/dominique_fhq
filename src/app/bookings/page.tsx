    ...
    >
      ...
      <td className="px-5">
        <p className="text-[12px] text-[#131313] font-medium">
          {formatShortDate(booking.pickup_datetime, booking.timezone)} - {formatTime(booking.pickup_datetime, booking.timezone)}
        </p>
      ...
      <td className="px-5">
        <p className="text-[12px] text-[#131313] font-medium">
          {formatShortDate(booking.dropoff_datetime, booking.timezone)} - {formatTime(booking.dropoff_datetime, booking.timezone)}
        </p>
