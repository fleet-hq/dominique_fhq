      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-8 py-6 pb-8 md:py-8 md:pb-28">
        ...
        <div className="mt-6 flex flex-col gap-4 md:flex-row md:items-start md:justify-between md:gap-0">
          ...
          <div className="no-print flex flex-wrap gap-3">
            ...
            >
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.5 3.5L3.5 10.5M3.5 3.5L10.5 10.5" stroke={verificationsComplete && bookingData?.canModify?.cancel ? '#141543' : '#9ca3af'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
              Cancel Trip
            </button>
            <button
