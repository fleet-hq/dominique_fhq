        ...
        {agreementData.signatureImage ? (
          <div className="space-y-2">
            ...
            <p className="text-xs text-green-600">
              Signed on {agreementData.signedAt ? new Date(agreementData.signedAt).toLocaleDateString(undefined, agreementData.timezone ? { timeZone: agreementData.timezone } : undefined) : 'N/A'}
            </p>
          </div>
        ) : (
          <SignaturePad
